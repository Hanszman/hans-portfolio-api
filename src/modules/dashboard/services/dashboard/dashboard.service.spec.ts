    ...
    expect(result.items).toEqual([
      {
        ...
        jobsPt: ['Frontend'],
        jobsEn: ['Frontend Engineer'],
        jobsEs: ['Ingeniero Front-End'],
        customers: ['PagBank'],
  ...
  it('builds normalized highlight cards across all entities and keeps icon/image paths null-safe', async () => {
      ...
      .mockResolvedValueOnce([
        {
          ...
          summaryEs: 'Experiencia en productos financieros.',
          highlight: true,
          imageAssets: [],
        },
      ])
    ...
    expect(secondResult.items).toEqual([
      ...
      },
      {
        ...
        titleEn: 'NestJS',
        titleEs: 'NestJS',
        subtitlePt: 'FRAMEWORKS',
        subtitleEn: 'FRAMEWORKS',
        subtitleEs: 'FRAMEWORKS',
        icon: null,
