...
export const CONTENT_RESOURCE_CONFIGS = {
  ...
  formations: {
    ...
    searchFields: ['slug', 'institution', 'titlePt', 'titleEn', 'titleEs'],
    filterDefinitions: [
      { queryKey: 'slug' },
  ...
  spokenLanguages: {
    ...
    searchFields: ['code', 'namePt', 'nameEn', 'nameEs'],
    filterDefinitions: [
      { queryKey: 'code' },
  ...
  customers: {
    ...
    searchFields: ['slug', 'name', 'summaryPt', 'summaryEn', 'summaryEs'],
    filterDefinitions: [
      { queryKey: 'slug' },
      { queryKey: 'name', operator: 'contains' },
      { queryKey: 'highlight' },
  ...
  links: {
    ...
    searchFields: ['url', 'labelPt', 'labelEn', 'labelEs'],
    filterDefinitions: [
      { queryKey: 'type' },
