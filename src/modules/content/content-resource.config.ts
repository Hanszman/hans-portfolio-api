...
export const CONTENT_RESOURCE_CONFIGS = {
  ...
  jobs: {
    ...
    hasPublishedFlag: true,
    defaultOrderBy: [{ sortOrder: 'asc' }, { slug: 'asc' }],
    sortableFields: ['sortOrder', 'slug', 'namePt', 'nameEn', 'highlight'],
  ...
  links: {
    ...
    sortableFields: ['sortOrder', 'labelPt', 'labelEn', 'type', 'url'],
  ...
  tags: {
    ...
    hasPublishedFlag: false,
    defaultOrderBy: [{ sortOrder: 'asc' }, { slug: 'asc' }],
    sortableFields: ['sortOrder', 'slug', 'namePt', 'nameEn', 'type'],
